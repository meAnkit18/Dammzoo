...
function NavBar() {
  ...
  return (
    ...
    <nav id="menu" class="max-md:absolute max-md:top-0 max-md:left-0 max-md:overflow-hidden items-center justify-center max-md:h-full max-md:w-0 transition-[width] flex-col md:flex-row flex gap-8 text-gray-900 text-sm font-normal">
        ...
        <a className="hover:text-indigo-600" href="#faqs">
            FAQs
        </a>
        <a className="hover:text-indigo-600" href="about">
            About
        </a>
        <a className="hover:text-indigo-600" href="disclaimer">
            Disclaimer
        </a>
    ...
    <div className="flex items-center space-x-4">
        <div className="hidden md:flex  bg-slate-800 text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-slate-900 transition cursor-pointer" onClick={()=> navigate('/login')}>
            Sign up
        </div>
