  ...
  return (
    <div>
       <style>{`
        ...
        <footer className="flex flex-col bg-gradient-to-r from-[#caeeff] to-[#fcd9f7] items-center justify-around w-full py-16 text-sm text-gray-800/70">
            <div className="flex items-center gap-8">
                <a href="#home" className="font-medium text-gray-500 hover:text-black transition-all">
                    Home
                </a>
            ...
            <div className="flex items-center gap-4 mt-8 text-slate-900">
                ...
                <a href="https://www.instagram.com/me.ankit18/" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.linkedin.com/in/meankit18/" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://x.com/meAnkit18" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/meAnkit18" className="hover:-translate-y-0.5 transition-all duration-300">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="mt-8 text-center">Copyright © {formatted} <a id='home'href="">Dammzoo</a>. All rights reservered.</p>
        </footer>
    </div>
  )
}
